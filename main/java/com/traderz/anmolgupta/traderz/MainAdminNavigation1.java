...
/**
 * Created by anmolgupta on 06/04/15.
 */
public class MainAdminNavigation1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_admin_navigation1);
       ...
       // getActionBar().setTitle(mTitle);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
                R.layout.drawable_list_item, items);
...
//        getActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    public void updateFragment() {
        ...
        AddConnection1 rFragment = new AddConnection1();
